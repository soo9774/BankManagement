...
//        next.setForeground(Color.WHITE);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            Conn c = new Conn();
            String query = "insert into signuptwo values('"+formno+"','"+sreligion+"','"+scategory+"','"+sincome+"','"+seducation+"','"+soccupation+"','"+span+"','"+sSSN+"','"+seniorcitizen+"','"+existingaccount+"')";
